...
export class Tab1Page implements OnInit {
  ...
  getPopulares() {
    this.seriesService.getPopulares()
      .subscribe( resp => {
      const arrTemp = [ ...this.seriesPopulares, ...resp.results ];
      this.seriesPopulares = arrTemp;
    });
  }
  getUltimas() {
    this.seriesService.getUltimas()
      .subscribe( resp => {
      this.seriesUltimas = resp.results;
    });
  }
